...
#define portSTACK_TYPE	uint32_os
...
typedef unsigned long UBaseType_t;
    ...
    typedef uint16_bs TickType_t;
    #define portMAX_DELAY ( TickType_t ) 0xffff
#else
    typedef uint32_os TickType_t;
...
#define portEXIT_CRITICAL()			vPortExitCritical()
	...
	#endif /* __GNUC__ */
#else
	extern void GetHighestBitInPattern ( uint32_os* bitnumber, uint32_os pattern);
	#define portGET_HIGHEST_PRIORITY( uxTopPriority, uxReadyPriorities )  GetHighestBitInPattern( (uint32_os* ) &( uxTopPriority ), ( uxReadyPriorities ) )
#endif //ALT_GET_HIGHEST_BIT	
